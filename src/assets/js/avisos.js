...
static comando_ok=null;
    ...
    static mostrar = (config, titulo, texto) => {
        ...
        this.comando_sn = config.comando_sn=()=>{config.comando_sn();}
        this.comando_ok = config.comando_ok=()=>{config.comando_ok();}
        ...
        areaCxmsg.setAttribute("id", "divmsg");
        ...
        tituloCxmsg.setAttribute("id", "divmsg");
        ...
        corpoCxmsg.setAttribute("id", "divmsg");
        ...
        rodapeCxmsg.setAttribute("id", "divmsg");
